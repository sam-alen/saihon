# Proyecto de Ecommerce de Libros _Saihon_

Repositorio del frontend del Proyecto de Libros _Saihon_, el Proyecto Integrador del Bootcamp de Generation México para la cohorte CH41.

## Descripción

El Proyecto de Libros _Saihon_ tiene como objetivo diseñar una plataforma dedicada a la venta de libros en línea puede ofrecer soluciones a distintas problemáticas, tanto para los vendedores como para los consumidores. Consiste en un **ecommerce** enfocado a la venta de libros de diferentes géneros literarios, la cual va dirigida a una público de 12 años en adelante, delimitada a la zona de la CDMX. Se desarrolló buscando satisfacer las siguientes necesidades:

1. Realizar una página web de venta de libros de fácil navegación.
2. Ofrecer a la venta diversos libros de ciencia y tecnología, romance y terror. (8 libros por categoría, sujeto de ampliación)
...
Para contribuir al repositorio, sigue estos pasos para asegurarte de que los cambios se suben correctamente a GitHub:
...
```bash
git clone git@github.com:sam-alen/saihon.git
cd saihon
```
